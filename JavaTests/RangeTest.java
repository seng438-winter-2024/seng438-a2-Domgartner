...
public class RangeTest {
    ...
    // Tests if the getLowerBound() method correctly gets the lower bound for a range of values negative to positive
    // type: ECP
    @Test
    ...
    // Tests if the getLowerBound() method correctly gets the lower bound for a range of negative values
    // type: ECP
    @Test
    ...
    // Tests if the getLowerBound() method correctly gets the lower bound for a range of positive values
    // type: ECP
    @Test
    ...
    // Tests if the getLowerBound() method correctly gets the lower bound for a small range of only 1 value
    // type: BVT
    @Test
    ...
    // Tests if the getLowerBound() method correctly gets the lower bound for a large range max value integers
    // type: BVT
    @Test
    ...
    // Tests if the getLowerBound() method correctly gets the lower bound for a range using double values
    // type: ECP
    @Test
    ...
    */
    ...
    // Tests the intersects() method of Range class with two different ranges that share an upper endpoint.
    // type: BVT
    @Test
